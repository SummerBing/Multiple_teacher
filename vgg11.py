...
from DML_ImageNet.util_D import AverageMeter, accuracy, transform_time, save_checkpoint, cpu_gpu
from DML_ImageNet.vgg_network import vgg11

os.environ['CUDA_VISIBLE_DEVICES'] = ''
parser = argparse.ArgumentParser(description='DML on ImageNet')
python_name = 'vgg11'
save_base_root_check = './vgg11-imagenet'
parser.add_argument('--name', default='VGG11')
...
parser.add_argument('--data', type=str, default='/home/jtcai/SharedSSD/Hsien/training')
